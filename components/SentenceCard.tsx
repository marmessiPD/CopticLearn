    ...
    return (
        <div className="bg-light-primary dark:bg-dark-secondary rounded-xl shadow-lg p-6 max-w-2xl mx-auto">
             <div className="space-y-4">
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    <p className="text-lg italic text-gray-600 dark:text-gray-400 text-center">{item.translit}</p>
                </div>
            ...
            <div className="text-center mt-6">
                 <button 
                    ...
                    aria-label={t({de: 'Satz anhören', en: 'Listen to sentence', ar: 'استمع للجملة'})}
                >
