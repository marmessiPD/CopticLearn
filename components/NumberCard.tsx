    ...
    return (
        <div className="bg-light-primary dark:bg-dark-secondary rounded-xl shadow-lg p-6 max-w-md mx-auto">
            <div className="w-full h-40 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-lg mb-4">
                <span className="text-8xl font-bold font-coptic text-coptic-blue dark:text-coptic-gold">{slide.copticSymbol}</span>
            </div>
            ...
            <div className="text-center mt-4">
                 <button 
                    onClick={() => playSound(slide.translit)}
                    ...
                    aria-label={t({de: 'Aussprache anhören', en: 'Listen to pronunciation', ar: 'استمع للنطق'})}
                >
