  ...
  return (
    <div className="bg-light-primary dark:bg-dark-secondary rounded-xl shadow-lg p-4 sm:p-6 max-w-2xl mx-auto">
      ...
      {slide.examples && slide.examples.length > 0 && (
        <div>
          <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-700 dark:text-gray-300">
          ...
          <div className="space-y-3">
            {slide.examples.map((example, index) => (
              <div
                key={index}
                className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg gap-3"
              >
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 flex-1 min-w-0">
                  <span className="font-coptic text-2xl sm:text-3xl flex-shrink-0">
                    {example.coptic}
                  </span>
