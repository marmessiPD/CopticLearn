...
const ReadingCard: React.FC<ReadingCardProps> = ({ slide }) => {
  ...
  return (
    <div className="bg-light-primary dark:bg-dark-secondary rounded-xl shadow-lg p-6 max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold text-coptic-blue dark:text-coptic-gold text-center mb-4">
        {t(slide.title)}
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold font-coptic text-center">
            Coptic Text
          </h3>
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-center">
            {t({ de: "Ãœbersetzung", en: "Translation", ar: "Ø§Ù„ØªØ±Ø¬Ù…Ø©" })}
          </h3>
            ...
            {slide.translation.map((p, index) => (
              <div key={index} className="flex items-start gap-2">
                ...
                <button
                  ...
                  aria-label={t({
                    de: "Absatz anhÃ¶ren",
                    en: "Listen to paragraph",
                    ar: "Ø§Ø³ØªÙ…Ø¹ Ù„Ù„ÙÙ‚Ø±Ø©",
                  })}
                >
                  <SpeakerIcon />
                </button>
